...
**Project:** MGA · **Owner:** Brett, AL Performance · **Version:** 1.3 · **Date:** 15 August 2026
...
**A note on names.** *MGA* ("my golf app") is the **project workspace** these documents live in — it is not, and was never intended to be, the product name. The **product name is Senda** (§4.4). Keep the two separate when reading anything below.
...
**A note on MGA.** *MGA* is the project workspace name — "my golf app" — and it works perfectly well as that. It is worth recording here only so nobody downstream mistakes it for a candidate brand, because as a **product** name it is unusable:
...
| **A 129-year-old US golf governing body** | [Metropolitan Golf Association](https://mgagolf.org/), founded 1897, runs GHIN handicapping services — in the largest market, in the exact same feature |
...
Keep using it for the repo, the workspace and internal shorthand. Just never let it reach a store listing.
...
| Name | Why |
|---|---|
| **MGA** | Project workspace name only — see §4.6. Never use it as the product name |
...
*Prepared by Claude for Brett, AL Performance. Version 1.3, 15 August 2026.*
